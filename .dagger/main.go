// A generated module for runtime functions
//
...
func (ci *Runtime) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (ci *Runtime) LintDagger(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
		From("golangci/golangci-lint:v1.62.0").
		WithMountedCache("/root/.cache/golangci-lint", dag.CacheVolume("golangci-lint"))
...
func (ci *Runtime) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (ci *Runtime) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
	containerPath := "/go/src/github.com/cryptellation/runtime"
	return c.
		// Add Go caches
